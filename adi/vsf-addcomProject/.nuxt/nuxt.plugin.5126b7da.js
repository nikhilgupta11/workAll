...
const moduleOptions = JSON.parse('{"i18n":{"useNuxtI18nConfig":true},"cookies":{"currencyCookieName":"vsf-currency","countryCookieName":"vsf-country","localeCookieName":"vsf-locale","cartCookieName":"vsf-cart","customerCookieName":"vsf-customer","storeCookieName":"vsf-store","messageCookieName":"vsf-message"},"externalCheckout":{"enable":false,"cmsUrl":"http://localhost:8080","syncUrlPath":"/vue/cart/sync","stores":{"default":false}},"defaultStore":"default","facets":{"available":["color","size","price"]},"magentoBaseUrl":"https://magento2-instance.vuestorefront.io/","imageProvider":"ipx","magentoApiEndpoint":"https://magento2demo.frodigo.com/graphql","customApolloHttpLinkOptions":{"useGETForQueries":true},"locales":[{"name":"default"},{"name":"german"}]}');
