...
const i18nCookiesPlugin = ({ $cookies, i18n, app, redirect }) => {
  const i18nOptions = {"country":"US","strategy":"prefix","locales":[{"code":"default","file":"en.js","iso":"en_US","defaultCurrency":"USD"},{"code":"german","file":"de.js","iso":"de_DE","defaultCurrency":"EUR"}],"defaultLocale":"default","autoChangeCookie":{"currency":false,"locale":false,"country":false},"lazy":true,"seo":true,"langDir":"lang\u002F","vueI18n":{"fallbackLocale":"default","numberFormats":{"default":{"currency":{"style":"currency","currency":"USD","currencyDisplay":"symbol"}},"german":{"currency":{"style":"currency","currency":"EUR","currencyDisplay":"symbol"}}}},"detectBrowserLanguage":false};
