...
export var CssPropControl = function (_a) {
    ...
    switch (control) {
        case "color":
            return React.createElement(ColorControl, __assign({}, props, { presetColors: presetColors }));
        case "text":
            return React.createElement(TextControl, __assign({}, props));
        default:
            return React.createElement(NoControl, null);
    }
};
