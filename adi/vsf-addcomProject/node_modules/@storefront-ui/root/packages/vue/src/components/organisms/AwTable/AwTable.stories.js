...
const Template = (args, { argTypes }) => ({
  ...
  <AwTable :class="classes">
    <AwTableHeading>
      ...
      <AwTableHeader><AwButton class="sf-button--text">Download all</AwButton></AwTableHeader>
    </AwTableHeading>
    <AwTableRow 
    ...
    > 
      <AwTableData
        ...
        <AwTableData><AwButton class="sf-button--text">View details</AwButton></AwTableData>
    </AwTableRow>
  </AwTable>`,
});
