...
const Template = (args, { argTypes }) => ({
  ...
  <AwTopBar>
    <template #center>
      ...
      <AwImage :width="24" :height="24" class="smartphone-only" src="/assets/storybook/SfTopBar/logo.svg" alt="logo"/>
    </template>
    <template #left>
    ...
    <template #right>
      ...
      <AwImage :width="20" :height="20" src="/assets/storybook/SfTopBar/flag.png" alt="flag of the USA"/>
    </template>
  </AwTopBar>`,
});
