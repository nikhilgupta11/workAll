              ...
              >
                ...
                <template #actions>
                  <div class="desktop-only collected-product__actions">
                    <AwButton class="sf-button--text collected-product__save">
                      Save for later
                    </AwButton>
                    <AwButton
      ...
      <template #content-bottom>
        <transition name="sf-fade">
          <div v-if="totalItems">
            ...
            >
              <template #value>
                <AwPrice :regular="totalPrice" />
              </template>
            </AwProperty>
            <AwButton class="sf-button--full-width color-secondary"
              >Go to checkout</AwButton
            >
          </div>
          <div v-else>
            <AwButton class="sf-button--full-width color-primary"
              >Go back shopping</AwButton
            >
          </div>
        </transition>
      </template>
...
import AwCollectedProduct from "../../organisms/AwCollectedProduct/AwCollectedProduct.vue";
