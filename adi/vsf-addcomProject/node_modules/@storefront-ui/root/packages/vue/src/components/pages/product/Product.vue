      ...
      <div class="product__info">
        ...
        <div>
          ...
          <AwAddToCart
            ...
            @click="addToCart"
          />
          <AwButton class="sf-button--text desktop-only product__save">
            Save for later
          </AwButton>
          <AwButton class="sf-button--text desktop-only product__compare">
            Add to compare
          </AwButton>
        </div>
        <AwTabs
          ...
          @click:tab="changeTab"
        >
          <AwTab v-for="tab in tabs" :key="tab.title" :title="tab.title">
            {{ tab.content }}
            <div v-if="tab.title === 'Description'">
              ...
              >
                <template v-if="detailed.name === 'Category'" #value>
                  <AwButton class="sf-button--text product__property__button">
                    {{ detailed.value }}</AwButton
                  >
                </template>
              </AwProperty>
            </div>
...
<script>
import AwGallery from "../../molecules/AwGallery/AwGallery.vue";
...
import AwReview from "../../molecules/AwReview/AwReview.vue";
...
import AwNotification from "../../molecules/AwNotification/AwNotification.vue";
