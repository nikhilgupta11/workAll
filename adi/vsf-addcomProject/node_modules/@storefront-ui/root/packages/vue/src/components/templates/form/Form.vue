<template>
  <div id="form-template">
    <form class="form">
      ...
      />
      <AwHeading title="Prices" :level="5" />
      <AwRange
        v-model="range"
      ...
      <div class="form__action">
        <AwButton type="submit" @click.prevent="submit">Submit</AwButton>
        <AwButton
          class="
            sf-button--text
...
import AwTextarea from "../../atoms/AwTextarea/AwTextarea.vue";
import AwHeading from "../../atoms/AwHeading/AwHeading.vue";
import AwRange from "../../molecules/AwRange/AwRange.vue";
