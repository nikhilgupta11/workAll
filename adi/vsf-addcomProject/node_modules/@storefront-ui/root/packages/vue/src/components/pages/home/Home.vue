<template>
  <div id="home">
    <AwHero class="hero" :slider-options="{ autoplay: false }">
      <AwHeroItem
    ...
    <AwBannerGrid class="banner-grid">
    ...
    <div class="match-with-it">
      ...
      <AwButton class="sf-button--text smartphone-only">See all</AwButton>
    </div>
    <AwCarousel
...
import AwHero from "../../organisms/AwHero/AwHero.vue";
import AwBannerGrid from "../../organisms/AwBannerGrid/AwBannerGrid.vue";
import AwBanner from "../../molecules/AwBanner/AwBanner.vue";
import AwCallToAction from "../../molecules/AwCallToAction/AwCallToAction.vue";
import AwSection from "../../molecules/AwSelect/AwSelect.vue";
import AwCarousel from "../../organisms/AwCarousel/AwCarousel.vue";
