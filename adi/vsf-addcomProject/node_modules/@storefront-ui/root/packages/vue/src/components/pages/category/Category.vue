  ...
  <div id="category">
    ...
    <div class="navbar section">
      <div class="navbar__aside desktop-only">
        <AwHeading :level="1" title="Categories" class="navbar__title" />
      </div>
      <div class="navbar__main">
        ...
        <div class="navbar__sort desktop-only">
          ...
          <AwComponentSelect v-model="sortBy" class="navbar__select">
            <AwComponentSelectOption
              v-for="option in sortByOptions"
              :key="option.value"
              :value="option.value"
              class="sort-by__option"
              >{{ option.label }}</AwComponentSelectOption
            >
          </AwComponentSelect>
        </div>
    ...
    <div class="main section">
      <div class="sidebar desktop-only">
        <AwAccordion :open="sidebarAccordion[0].header" :show-chevron="true">
          <AwAccordionItem
            ...
            <template>
              <AwList class="list">
                <AwListItem
                  ...
                  class="list__item"
                >
                  <AwMenuItem :label="item.label" :count="item.count" />
                </AwListItem>
              </AwList>
            </template>
          </AwAccordionItem>
      ...
      <div class="products">
        ...
        <div class="products__show-on-page desktop-only">
          ...
          <AwSelect class="products__items-per-page">
            <AwSelectOption
    ...
    >
      ...
      <AwAccordion class="filters smartphone-only">
        <AwAccordionItem header="Show on page" class="filters__accordion-item">
        ...
        <AwAccordionItem header="Sort by" class="filters__accordion-item">
          <template #additional-info>
        ...
        <AwAccordionItem header="Category" class="filters__accordion-item">
          <template #additional-info>
            <span class="filters__chosen">
              {{ category }}
            </span>
        ...
        <AwAccordionItem header="Collection" class="filters__accordion-item">
          <AwFilter
            v-for="filter in filters.collection"
            :key="filter.value"
            :label="filter.label"
        ...
        <AwAccordionItem header="Color" class="filters__accordion-item">
          <AwFilter
            v-for="filter in filters.color"
            :key="filter.value"
            :label="filter.label"
        ...
        <AwAccordionItem header="Size" class="filters__accordion-item">
          <AwFilter
            v-for="filter in filters.size"
            :key="filter.value"
            :label="filter.label"
        ...
        <AwAccordionItem header="Price" class="filters__accordion-item">
          <AwFilter
            v-for="filter in filters.price"
            :key="filter.value"
            :label="filter.label"
        ...
        <AwAccordionItem header="Material" class="filters__accordion-item">
          <AwFilter
            v-for="filter in filters.material"
            :key="filter.value"
            :value="filter.value"
...
import AwSidebar from "../../organisms/AwSidebar/AwSidebar.vue";
...
import AwFilter from "../../molecules/AwFilter/AwFilter.vue";
import AwProductCard from "../../organisms/AwProductCard/AwProductCard.vue";
import AwProductCardHorizontal from "../../organisms/AwProductCardHorizontal/AwProductCardHorizontal.vue";
import AwPagination from "../../molecules/AwPagination/AwPagination.vue";
import AwAccordion from "../../organisms/AwAccordion/AwAccordion.vue";
...
import AwRadio from "../../molecules/AwRadio/AwRadio.vue";
