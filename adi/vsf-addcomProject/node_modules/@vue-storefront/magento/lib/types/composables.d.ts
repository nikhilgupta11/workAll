import { Composable, ComposableFunctionArgs, ComputedProperty, CustomQuery } from '@vue-storefront/core';
import { ComputedRef, Ref } from '@vue/composition-api';
import { PlatformApi } from '@vue-storefront/core/lib/src/types';
import { FetchPolicy } from './index';
export declare type CustomQueryParams = {
    customQuery?: CustomQuery;
    [k: string]: any;
};
export interface UseUrlResolver<ROUTE, API extends PlatformApi = any> extends Composable<API> {
    search: (params: ComposableFunctionArgs<{
        url: string;
    }>) => Promise<void>;
...
export interface UseExternalCheckout<API extends PlatformApi = any> extends Composable<API> {
    initializeCheckout: (params: ComposableFunctionArgs<{
        baseUrl: string;
    }>) => Promise<string>;
...
export interface UseContent<PAGE, BLOCK, API extends PlatformApi = any> extends Composable<API> {
    ...
    loadContent: (params: ComposableFunctionArgs<{
        identifier: string;
    }>) => Promise<void>;
    loadBlocks: (params: ComposableFunctionArgs<{
        identifiers: string[];
    }>) => Promise<void>;
    loading: ComputedProperty<boolean>;
...
export interface UsePaymentProvider<STATE, PAYMENT_METHOD, API extends PlatformApi = any> extends Composable<API> {
    ...
    save(params: ComposableFunctionArgs<{
...
export interface UseReview<REVIEW, REVIEWS_SEARCH_PARAMS, REVIEWS_USER_SEARCH_PARAMS, REVIEW_ADD_PARAMS, REVIEW_METADATA, API extends PlatformApi = any> extends Composable<API> {
...
export interface UseNewsletter<UPDATE_NEWSLETTER_PARAMS, API extends PlatformApi = any> extends Composable<API> {
    ...
    loading: ComputedProperty<boolean>;
    updateSubscription: (params: ComposableFunctionArgs<{
...
export interface UseAddresses<ADDRESS, LOAD_ADDRESS_PARAMS extends {
    customQuery?: CustomQuery;
    ...
    customQuery?: CustomQuery;
} = CustomQueryParams, API extends PlatformApi = any> extends Composable<API> {
...
export interface UseCurrency<CURRENCY, API extends PlatformApi = any> extends Composable<API> {
    load: (params?: ComposableFunctionArgs<{}>) => Promise<void>;
    change: (params: ComposableFunctionArgs<{
        id: string;
    }>) => void;
...
export interface UseWishlist<WISHLIST, WISHLIST_ITEM, PRODUCT, API extends PlatformApi = any> extends Composable<API> {
    ...
    addItem(params: ComposableFunctionArgs<{
        product: PRODUCT;
    }>): Promise<void>;
    removeItem(params: ComposableFunctionArgs<{
