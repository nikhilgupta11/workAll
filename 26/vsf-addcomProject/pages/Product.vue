          ...
          <div class="product__info">
            ...
            <div>
              ...
              <AwAddToCart
                ...
                :disabled="(col === false || siz === false) || loading || productLoading"
...
export default defineComponent({
  ...
  setup() {
    ...
    const updateProductConfiguration = async (label, value) => {
      ...
      if(label == "MTQ0") {
        // localStorage.getItem("col")===true?col.value=true:null;
        siz.value=true
      }
      // console.log(col.value)
      // console.log(siz.value)
    ...
    // const len = configurableOptions.value? true:false;
    // console.log(configurableOptions.value)
    // console.log(len);

    const opt = configurableOptions.value
    // console.log(opt)
